...
include("conf.php");
include("header.php");
if ($t != "cats") {  if ($t != "dogs") { echo "Error"; exit(); } }
...
echo "</tr></table><hr><br>";
echo "<b>If you are interested in adopting one of our ";
if ($t == "cats") { echo 'cats'; }
if ($t == "dogs") { echo 'dogs'; }
echo " above please contact us to arrange an appointment to come and meet in person at our shelter.</b>";
include("footer.php");
?>